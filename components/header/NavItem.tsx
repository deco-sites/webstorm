  ...
  return (
    <li class="group flex items-center p-2">
      <a href={href} class="px-4 py-3">
        <span class="group-hover:underline hover:underline uppercase text-[#8C8C8C] font-medium text-sm font-sans">
          {label}
        </span>
      </a>
                ...
                <li class="p-6">
                  ...
                  <ul class="flex flex-col gap-1 mt-4">
                    {node.children?.map((leaf) => (
                      <li>
                        <a
                          class="hover:underline uppercase text-[#8C8C8C] font-medium text-sm font-sans "
                          href={leaf.href}
                        >
